...
class smart_fb_page_like_box extends WP_Widget{
	public function __construct(){
		parent:: __construct('smart_fb_page_like_box', 'smart page liker',array(
 ...
 public	function form($instance){
       ...
       <p>
         ...
         <p style="font-weight:bold;">
       	 <a style="color:green;font-size:20px" href="https://goo.gl/crjChP">Customize Your Website ??</a>
       </p>
